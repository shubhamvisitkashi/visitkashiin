        ...
        <div class="container-fluid">
            ...
            <div class="card shadow-sm">
                <div class="card-body p-3 p-md-4">
                    <form id="valid_form" method="POST" action="{{ route('lead.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <label for="enquiry_date" class="form-label fw-semibold">
                                        Enquiry Date <span style="color: #dc3545;">*</span>
                                    </label>
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    ...
                                    <input type="text" name="daterange" id="booking_daterange"
                                        placeholder="Select booking dates..." value="{{ old('daterange') }}"
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <label for="lead_source_id" class="form-label fw-semibold">
                                        Lead Source <span style="color: #dc3545;">*</span>
                                    </label>
                                        ...
                                        <select class="form-control js-example-basic-single" name="lead_source_id"
                                            ...
                                            @foreach ($lead_sources as $lead_source)
                                                <option value="{{ $lead_source->id }}"
                                                    @if (old('lead_source_id') == $lead_source->id) selected @endif>
                                                    {{ $lead_source->name }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-md-6 col-lg-4">
                                    ...
                                    <input id="guest_name" class="form-control" type="text" name="guest_name"
                                        placeholder="Enter guest name" value="{{ old('guest_name') }}">
                                    @error('guest_name')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    ...
                                    <input id="pax" class="form-control" type="number" name="pax"
                                        placeholder="Enter number of guests" value="{{ old('pax') }}" min="1">
                                    @error('pax')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <textarea id="short_plan" class="form-control" name="short_plan" rows="3"
                                        placeholder="Brief description of customer requirements or travel plan">{{ old('short_plan') }}</textarea>
                                        ...
                                        @foreach ($serviceTypes ?? [] as $serviceType)
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="service_ids[]"
                                                    ...
                                                    @if (old('service_ids') && in_array($serviceType->id, old('service_ids'))) checked @endif>
