...
@section('content')
                        ...
                        <form method="POST" action="{{ route('quotations.store') }}" id="quotation-form">
                            ...
                            <div class="row g-3">
                                    ...
                                    <select id="lead_id" class="form-select @error('lead_id') is-invalid @enderror"
                                        ...
                                        @foreach ($leads as $leadOption)
                                            <option value="{{ $leadOption->id }}"
                                                {{ old('lead_id', $lead?->id) == $leadOption->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" id="quotation_date"
                                        ...
                                        name="quotation_date" value="{{ old('quotation_date', now()->format('Y-m-d')) }}"
                                        required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="itinerary_html" name="itinerary_html" rows="10">{{ old('itinerary_html') }}</textarea>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" step="0.01" id="service_charge"
                                                        ...
                                                        value="{{ old('service_charge', 0) }}" min="0"
                                                    ...
                                                    <div class="d-flex gap-3 align-items-center">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="gst_type"
                                                                ...
                                                                {{ old('gst_type', 'exclude') == 'include' ? 'checked' : '' }}>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="gst_type"
                                                                ...
                                                                onchange="calculateTotal()"
                                                                {{ old('gst_type', 'exclude') == 'exclude' ? 'checked' : '' }}>
                                                        ...
                                                        <input type="number" step="0.01" id="gst_percentage"
                                                            ...
                                                            value="{{ old('gst_percentage', 18) }}" min="0"
                                                    ...
                                                    <div class="row g-2 align-items-center">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="number" step="0.01" class="form-control"
                                                                id="custom_total" name="custom_total" value="0"
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i data-feather="save"></i> Create Quotation
                                </button>
    ...
    <script>
                    ...
                    <div class="row g-2 align-items-end">
                        <div class="col-md-3">
                            ...
                            <select class="form-select form-select-sm category-select" onchange="filterServiceTemplates(${itemIndex})" required>
                                ...
                                ${[...new Set(serviceTemplates.map(t => t.service_type.name))].map(cat => `<option value="${cat}">${cat}</option>`).join('')}
                            </select>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select-sm template-select" name="items[${itemIndex}][service_template_id]"
                                    onchange="loadTemplateDetails(${itemIndex})" required disabled>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" step="0.01" class="form-control form-control-sm price-input" name="items[${itemIndex}][unit_price]"
                                   value="0" min="0" onchange="calculateTotal()" required>
                            <input type="hidden" name="items[${itemIndex}][quantity]" value="1">
                        </div>
                        <div class="col-md-2">
                            <label class="form-label small">Service Date</label>
                            <input type="date" class="form-control form-control-sm" name="items[${itemIndex}][service_date]">
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-12 custom-name-row d-none mt-2">
                            ...
                            <input type="text" class="form-control form-control-sm custom-name-input" name="items[${itemIndex}][custom_name]" placeholder="Enter custom item name">
                        </div>
                    </div>
                </div>
            </div>
        ...
        function filterServiceTemplates(index) {
            ...
            if (selectedCategory) {
                ...
                const serviceTypeId = filteredTemplates.length ? filteredTemplates[0].service_type.id : '';
                templateSelect.innerHTML = '<option value="">Select Service</option>' +
                    filteredTemplates.map(t =>
                        `<option value="${t.id}" data-price="${t.default_selling_price}">${t.name}</option>`).join('') +
                    `<option value="__custom__" data-service-type-id="${serviceTypeId}">✏️ Type custom name…</option>`;
