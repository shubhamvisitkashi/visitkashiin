                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input id="name" class="form-control" type="text" name="name"
                                        value="{{ old('name',$agent->name) }}" placeholder="Agent Name..." required>
                                    @error('name')
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input id="contact_number" class="form-control" type="number" name="contact_number"
                                        value="{{ old('contact_number',$agent->contact_number) }}" placeholder="Contact Number..." required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input id="alt_contact_number" class="form-control" type="number"
                                        name="alt_contact_number" value="{{ old('alt_contact_number',$agent->alt_contact_number) }}" placeholder="Alt Contact Number...">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="state" id="state" class="form-control js-example-basic-single" onchange="getCity()">
                                        ...
                                        @foreach ($states as $state)
                                            <option value="{{$state->state}}" @if(old('state',$agent->state) == $state->state) selected @endif>{{$state->state}}</option>
                                        @endforeach
                                    </select>
                                    @error('state')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-12 mb-3">
                                    @foreach ($agent_services as $agent_service)
                                        ...
                                        <input type="checkbox" name="service_ids[]" value="{{ $agent_service->id }}" @if(in_array($agent_service->id,old('service_ids[]',$agent->service_ids)??[])) checked @endif>
                                    @endforeach
                                </div>
                            </div>
            ...
            function getCity(){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        var old_city = "{{old('city',$agent->city)}}";
                        $('#city').empty();
