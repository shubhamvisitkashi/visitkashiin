...
@section('content')
    <div class="page-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold text-primary mb-1">Edit Boat</h2>
                <p class="text-muted mb-0">Update boat information</p>
            </div>
            <div>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-gradient-primary text-white border-0">
                        <h5 class="mb-0 fw-semibold"><i class="fas fa-edit me-2"></i>Edit Boat Information</h5>
                    </div>
                    <div class="card-body p-4">
                        <form id="boat_form" method="POST" action="{{route('boat.update', $boat->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <select id="boat_type_id" class="form-select form-select-lg border-2" name="boat_type_id" required>
                                        ...
                                        @foreach($boat_types as $boat_type)
                                            <option value="{{$boat_type->id}}" @if(old('boat_type_id', $boat->boat_type_id) == $boat_type->id) selected @endif>{{$boat_type->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('boat_type_id')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="event_type" class="form-select form-select-lg border-2" name="event_type" required>
                                        ...
                                        <option value="Regular" @if(old('event_type', $boat->event_type) == 'Regular') selected @endif>🌊 Regular</option>
                                        <option value="Festival" @if(old('event_type', $boat->event_type) == 'Festival') selected @endif>🎉 Festival</option>
                                    </select>
                                    @error('event_type')
                                        <div class="text-danger small mt-1"><i class="fas fa-exclamation-circle me-1"></i>{{$message}}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="total_available_boat" class="form-control form-control-lg border-2" type="number" name="total_available_boat" value="{{old('total_available_boat', $boat->total_available_boat)}}" placeholder="Enter total available boats" min="1" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="no_of_seat" class="form-control form-control-lg border-2" type="number" name="no_of_seat" value="{{old('no_of_seat', $boat->no_of_seat)}}" placeholder="Enter number of seats (per Boat)" min="1" required>
                                    @error('no_of_seat')
                                        <div class="text-danger small mt-1"><i class="fas fa-exclamation-circle me-1"></i>{{$message}}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input id="price" class="form-control border-2" type="number" name="price" value="{{old('price', $boat->price)}}" placeholder="Enter regular price" min="0" step="0.01" required>
                                    </div>
                                    @error('price')
                                        <div class="text-danger small mt-1"><i class="fas fa-exclamation-circle me-1"></i>{{$message}}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text bg-light">₹</span>
                                        <input id="discounted_price" class="form-control border-2" type="number" name="discounted_price" value="{{old('discounted_price', $boat->discounted_price)}}" placeholder="Enter discounted price" min="0" step="0.01">
                                    </div>
                            ...
                            <div class="mt-5 pt-4 border-top">
                                <div class="d-flex gap-3 justify-content-center">
                                    <button type="submit" class="btn btn-primary btn-lg px-5"><i class="fas fa-save me-2"></i>Update Boat</button>
