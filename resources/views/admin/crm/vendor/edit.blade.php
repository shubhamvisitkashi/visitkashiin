                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input id="name" class="form-control" type="text" name="name"
                                        value="{{ old('name',$vendor->name) }}" placeholder="Vendor Name..." required>
                                    @error('name')
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input id="contact_number" class="form-control" type="number" name="contact_number"
                                        value="{{ old('contact_number',$vendor->contact_number) }}" placeholder="Contact Number..." required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input id="alt_contact_number" class="form-control" type="number"
                                        name="alt_contact_number" value="{{ old('alt_contact_number',$vendor->alt_contact_number) }}" placeholder="Alt Contact Number...">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="state" id="state" class="form-control js-example-basic-single" onchange="getCity()">
                                        ...
                                        @foreach ($states as $state)
                                            <option value="{{$state->state}}" @if(old('state',$vendor->state) == $state->state) selected @endif>{{$state->state}}</option>
                                        @endforeach
                                    </select>
                                    @error('state')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input id="address" class="form-control" type="text" name="address"
                                        value="{{ old('address',$vendor->address) }}" placeholder="Address...">
                                    @error('address')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-2 mb-3">
                                        <input type="checkbox" name="service_ids[]" class="form-check-input" value="{{ $vendor_service->id }}" @if(in_array($vendor_service->id,old('service_ids[]',$vendor->service_ids)??[])) checked @endif>
            ...
            function getCity(){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        var old_city = "{{old('city',$vendor->city)}}";
                        $('#city').empty();
