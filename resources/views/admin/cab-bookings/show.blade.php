    ...
    <div class="cs-sidebar">
      ...
      <div class="cs-scard">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ...
          <form id="deleteCabBookingForm" action="{{ route('cab-bookings.destroy', $booking->id) }}" method="POST">
            @csrf @method('DELETE')
            <button type="button" onclick="confirmDeleteCabBooking()" class="cs-btn rose" style="width:100%;justify-content:center;">
...
function confirmDeleteCabBooking() {
    Swal.fire({
        ...
        html: '<p style="margin:0;font-size:.9rem;color:#6B7280;">Booking <strong style="color:#DC2626;">{{ $booking->booking_number }}</strong> will be deleted.</p>',
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            Swal.fire({
                ...
                if (result2.isConfirmed) {
                    document.getElementById('deleteCabBookingForm').submit();
                }
            });
        }
    });
