                                        ...
                                        <div class="card card-outline card-primary">
                                            ...
                                            <div class="card-body" style="height: 170px; overflow-x: hidden;">
                                                ...
                                                @foreach ($permission as $value)
                                                    <div class="mb-2">
                                                        <input type="checkbox" name="permission[]" id="roles_{{$value->name}}" class="roles_{{$parent->parent_name}} form-check-input me-2" value="{{$value->id}}" @if(in_array($value->id, $rolePermissions)) checked @endif>
